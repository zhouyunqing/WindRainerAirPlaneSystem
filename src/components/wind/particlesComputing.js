...
class ParticlesComputing {
  ...
  createWindTextures (context, data) {
    ...
    this.windTextures = {
      ...
      LON:Util.createTexture(windTextureOptions, data.lon.array),
      LAT:Util.createTexture(windTextureOptions, data.lat.array)
    }
  }
    ...
    this.primitives = {
      getWind: new CustomPrimitive({
        ...
        uniformMap: {
          ...
          LON: function () {
              return that.windTextures.LON;
          },
          LAT: function () {
              return that.windTextures.LAT;
          },
